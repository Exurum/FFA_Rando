...
spawnNPC:
    ...
    ld   C, L                                          ;; 03:4324 $4d
; Optimize to free some space for Sleep/Mute bugfix
    swap A
    and a, $0f
    cpl                                                ;; 03:432d $2f
    inc  A                                             ;; 03:432e $3c
...
.jr_03_4336:
    ...
    rl   B                                             ;; 03:4340 $cb $10
    pop  DE                                            ;; 03:4342 $d1
; Bugfix: Properly clear the Sleep and Mute status.
; Prevents immune enemies from Sleep or Mute status.
    ld hl, $000a
...
npcActionJumptable:
    ...
    dw   npcBehaviorManageProjectiles                                  ;; 03:4c5b pP $03
...
npcSpawnProjectileAction:
    ...
    ld   C, A                                          ;; 03:4eeb $4f
    call npcBehaviorManageProjectiles                                  ;; 03:4eec $cd $f0 $4e
    ret                                                ;; 03:4eef $c9

npcBehaviorManageProjectiles:
    ld   A, C                                          ;; 03:4ef0 $79
    dec  A                                             ;; 03:4ef1 $3d
    push AF                                            ;; 03:4ef2 $f5
